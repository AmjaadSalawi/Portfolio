    ...
    >
      <div className="flex gap-y-5 xl:gap-y-10 flex-col pt-7 xl:pt-36 pb-10 xl:pb-20 px-4 xl:px-0 ">
        ...
        <div className="text-white/80 text-xl xl:text-lg font-extralight">
          ...
          I am a professional graphic designer. I have experience in designing, Logos, Social Media, video editing and motion. I use Adobe Illustrator, Adobe Photoshop, Adobe After Effect and Adobe premiere pro. Not only that, but I will provide high-quality work that will happy all my clients.
          </motion.p>
          <br />
